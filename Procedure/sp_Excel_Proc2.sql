...
DROP PROCEDURE IF EXISTS sp_Excel_Proc2$$

CREATE PROCEDURE sp_Excel_Proc2(IN tempTableName VARCHAR(255))
BEGIN
    /*--================================================================================
    -- 엑셀 업로드 데이터 처리
	--    송장출력메세지 엑셀파일을 읽어서 테이블 Insert
    --================================================================================*/
    ...
    SET @processSql = CONCAT('
        INSERT INTO 송장출력_메세지 (
            쇼핑몰, msg1, msg2, msg3, msg4, msg5, msg6 
        )
        SELECT 
            쇼핑몰,
            msg1,
