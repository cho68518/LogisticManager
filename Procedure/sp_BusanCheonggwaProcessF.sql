...
BEGIN
    ...
    INSERT INTO sp_execution_log (OperationDescription, AffectedRows) VALUES ('[TEMP] temp_invoices 생성 및 청과낱개 데이터 분류', ROW_COUNT());
